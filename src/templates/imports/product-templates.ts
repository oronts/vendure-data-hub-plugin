...
export const simpleProductsTemplate: ImportTemplate = {
    ...
    description: 'Import basic products with name, SKU, price, and description from a CSV file.',
    category: 'products',
    icon: 'shopping-bag',
    difficulty: 'beginner',
...
export const productsWithVariantsTemplate: ImportTemplate = {
    ...
    description: 'Import products with multiple variants (sizes, colors) from a CSV file.',
    category: 'products',
    icon: 'layers',
...
export const shopifyProductsTemplate: ImportTemplate = {
    ...
    description: 'Import products exported from Shopify in their standard CSV format.',
    category: 'products',
    icon: 'shopping-cart',
    difficulty: 'intermediate',
