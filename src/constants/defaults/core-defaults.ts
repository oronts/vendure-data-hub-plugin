 ...
 */
import { PORTS, RETENTION } from '../../../shared/constants';
export { PORTS, RETENTION };
...
export const TRANSFORM_LIMITS = {
    ...
    /** Maximum files to include in extractor preview/sample results */
    MAX_PREVIEW_FILES: 5,
...
export const REMOTE_SOURCE_ACKNOWLEDGEMENT_RECOVERY = {
    RECONCILE_INTERVAL_MS: 30_000,
    BATCH_SIZE: 100,
    RUN_ID_QUERY_BATCH_SIZE: 500,
    JOB_RETRIES: 2,
} as const;
