...
import {
    ...
    OPTIONS_MODE_OPTIONS,
    FILTERS_MODE_OPTIONS,
        ...
        definition: {
            ...
            schema: {
                fields: [
                    ...
                    { key: 'facetValuesMode', label: 'Facet values mode', type: 'select', options: FACET_VALUES_MODE_OPTIONS, description: 'How to handle product facet values on update' },
                    { key: 'assetsMode', label: 'Assets mode', type: 'select', options: ASSETS_MODE_OPTIONS, description: 'How to handle product assets on update' },
                    { key: 'featuredAssetMode', label: 'Featured asset mode', type: 'select', options: FEATURED_ASSET_MODE_OPTIONS, description: 'How to handle product featured asset on update' },
                ],
            },
        },
    }],
        ...
        definition: {
            ...
            schema: {
                fields: [
                    ...
                    { key: 'facetValuesMode', label: 'Facet values mode', type: 'select', options: FACET_VALUES_MODE_OPTIONS, description: 'How to handle variant facet values on update' },
                    { key: 'assetsMode', label: 'Assets mode', type: 'select', options: ASSETS_MODE_OPTIONS, description: 'How to handle variant assets on update' },
                    { key: 'featuredAssetMode', label: 'Featured asset mode', type: 'select', options: FEATURED_ASSET_MODE_OPTIONS, description: 'How to handle variant featured asset on update' },
                    { key: 'optionsMode', label: 'Options mode', type: 'select', options: OPTIONS_MODE_OPTIONS, description: 'How to handle variant options on update' },
                ],
            },
        },
    }],
        ...
        definition: {
            ...
            schema: {
                fields: [
                    ...
                    { key: 'assetsMode', label: 'Assets mode', type: 'select', options: ASSETS_MODE_OPTIONS, description: 'How to handle collection assets on update' },
                    { key: 'filtersMode', label: 'Filters mode', type: 'select', options: FILTERS_MODE_OPTIONS, description: 'How to handle collection filters on update' },
                ],
            },
        },
    }],
        ...
        definition: {
            ...
            schema: {
                fields: [
                    ...
                    { key: 'conditionsMode', label: 'Conditions mode', type: 'select', options: CONDITIONS_MODE_OPTIONS, description: 'How to handle promotion conditions on update' },
                    { key: 'actionsField', label: 'Actions field (JSON)', type: 'string' },
                    { key: 'actionsMode', label: 'Actions mode', type: 'select', options: ACTIONS_MODE_OPTIONS, description: 'How to handle promotion actions on update' },
                    { key: 'channel', label: 'Channel code', type: 'string' },
                    { key: 'customFieldsField', label: 'Custom fields field (object)', type: 'string', description: 'Record field containing custom field values (defaults to "customFields")' },
