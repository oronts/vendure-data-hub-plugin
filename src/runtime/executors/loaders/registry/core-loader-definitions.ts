        ...
        definition: {
            ...
            schema: {
                fields: [
                    ...
                    { key: 'optionIdsField', label: 'Option IDs field (array)', type: 'string', description: 'Record field containing pre-existing Vendure option IDs (e.g. [1, 2, 3]). Applied on create and update.' },
                    { key: 'optionCodesField', label: 'Option codes field (array)', type: 'string', description: 'Record field containing option codes (e.g. ["size-s", "color-blue"]). Resolved within the parent product and applied on create and update.' },
