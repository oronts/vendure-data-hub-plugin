/**
 * Vendure Events Constants
 * Vendure event definitions for event triggers
 */

// Vendure event configuration interface
...
// Vendure events available for event triggers
...
// Group events by category for easier UI rendering
