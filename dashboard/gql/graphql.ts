...
export type DataHubPipelineDetailQuery = { __typename?: 'Query', dataHubPipeline?: { __typename?: 'DataHubPipeline', id: string | number, createdAt: string, updatedAt: string, code: string, name: string, enabled: boolean, configurationSource: string, status: DataHubPipelineStatus, version: number, currentRevisionId?: string | number | null, publishedVersionCount: number, publishedAt?: string | null, definition: Record<string, unknown>, channels: Array<{ __typename?: 'Channel', id: string | number, code: string, token: string }> } | null };
