...
export type DataHubConnectionDetailApiQuery = { __typename?: 'Query', dataHubConnection?: { __typename?: 'DataHubConnection', id: string | number, code: string, type: string, configurationSource: string, config: Record<string, unknown> } | null };
...
export type DataHubConsumersApiQuery = { __typename?: 'Query', dataHubConsumers: Array<{ __typename?: 'DataHubConsumerStatus', pipelineCode: string, triggerKey: string, queueName: string, isActive: boolean, messagesProcessed: number, messagesFailed: number, lastMessageAt?: string | null }> };
