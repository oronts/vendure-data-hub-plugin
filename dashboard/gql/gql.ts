...
type Documents = {
    ...
    "\n    mutation StartDataHubPipelineRunApi($pipelineId: ID!) {\n        startDataHubPipelineRun(pipelineId: $pipelineId) {\n            id\n            status\n        }\n    }\n": typeof types.StartDataHubPipelineRunApiDocument,
    ...
    "\n    mutation RetryDataHubRecordFromQueueApi($errorId: ID!, $patch: JSON) {\n        retryDataHubRecord(errorId: $errorId, patch: $patch)\n    }\n": typeof types.RetryDataHubRecordFromQueueApiDocument,
    ...
    "\n    mutation SetDataHubSettingsApi($input: DataHubSettingsInput!) {\n        setDataHubSettings(input: $input) {\n            retentionDaysRuns\n            retentionDaysErrors\n            retentionDaysLogs\n            logPersistenceLevel\n        }\n    }\n": typeof types.SetDataHubSettingsApiDocument,
};
const documents: Documents = {
    "\n    query DataHubAdaptersApi {\n        dataHubAdapters {\n            type\n            code\n            name\n            description\n            category\n            schema {\n                fields {\n                    key\n                    label\n                    description\n                    type\n                    required\n                    defaultValue\n                    placeholder\n                    options {\n                        value\n                        label\n                    }\n                }\n            }\n            icon\n            color\n            pure\n            async\n            batchable\n            requires\n        }\n    }\n": types.DataHubAdaptersApiDocument,
    "\n    query DataHubVendureSchemasApi {\n        dataHubVendureSchemas {\n            entity\n            label\n            description\n            fields {\n                key\n                type\n                required\n                readonly\n                description\n            }\n            lookupFields\n            importable\n            exportable\n        }\n    }\n": types.DataHubVendureSchemasApiDocument,
    ...
    "\n    mutation StartDataHubPipelineRunApi($pipelineId: ID!) {\n        startDataHubPipelineRun(pipelineId: $pipelineId) {\n            id\n            status\n        }\n    }\n": types.StartDataHubPipelineRunApiDocument,
    ...
    "\n    mutation RetryDataHubRecordFromQueueApi($errorId: ID!, $patch: JSON) {\n        retryDataHubRecord(errorId: $errorId, patch: $patch)\n    }\n": types.RetryDataHubRecordFromQueueApiDocument,
    ...
    "\n    mutation SetDataHubSettingsApi($input: DataHubSettingsInput!) {\n        setDataHubSettings(input: $input) {\n            retentionDaysRuns\n            retentionDaysErrors\n            retentionDaysLogs\n            logPersistenceLevel\n        }\n    }\n": types.SetDataHubSettingsApiDocument,
};
