...
import type { PipelineNodeData, PipelineDefinition, TriggerConfig, VisualPipelineEditorProps, VendureEntitySchema } from './types';
        ...
        (event: React.DragEvent) => {
            ...
            const newNode: Node<PipelineNodeData> = {
                ...
                data: {
                    ...
                    config: { adapterCode: nodeType },  // Set adapterCode in both places for consistency
                },
            };
