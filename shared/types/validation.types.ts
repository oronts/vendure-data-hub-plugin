 ...
 * Validation Types
 *
 * Validation types, error codes, and error messages shared between frontend and backend.
 * Self-contained with no external imports for cross-project TypeScript compatibility.
 *
